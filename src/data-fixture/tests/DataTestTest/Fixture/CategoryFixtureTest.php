...
use TestData\Fixture\CategoryFixture;
...
{   
    ...
    public function setUp()
    {
        ...
        $this->repository = new \TestData\Entity\Category;
    ...
    {
        $this->assertInstanceOf('TestData\Entity\Category', $this->repository);
    }
    ...
    {
        $categoryFixture = new \TestData\Fixture\CategoryFixture();
